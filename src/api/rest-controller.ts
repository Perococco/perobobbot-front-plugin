...
export class PluginController {
    ...
    public getPluginTemplate(groupId: string, artifactId: string): Promise<AxiosResponse> {
        const url = new URL('/api/plugin/' + groupId + ':' + artifactId + '', this.baseURL);
...
export class TokenController {
    ...
    public initiateOAuth(parameter: any): Promise<any> {
